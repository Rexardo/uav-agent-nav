...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--render-frames",
        type=int,
        default=RACERConfig.render_interpolation_frames,
        help="Interpolated display frames between two simulation positions.",
    )
...
def format_result(result: dict[str, Any]) -> str:
    return (
        ...
        f"collision_events={result['collision_events']}, "
