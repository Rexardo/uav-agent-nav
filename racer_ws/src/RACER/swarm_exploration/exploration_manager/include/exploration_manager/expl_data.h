...
struct FSMParam {
  ...
  int unreachable_release_count_;
};
...
struct ExplorationParam {
  ...
  double astar_search_time_;
  double astar_fallback_resolution_;
  double astar_fallback_search_time_;
  int max_viewpoint_trials_;
